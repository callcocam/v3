<fieldset>
    <label class="my-2" title="Click para copiar"> Descrição Encarte <span class="text-danger font-bold">{{ $description_ERP }} </span><<< <a wire:click.prevent="copyEncart" href="">Click para copiar</a></label>
