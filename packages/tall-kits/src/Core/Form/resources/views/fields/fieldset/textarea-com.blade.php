<fieldset>
    <label class="my-2" title="Click para copiar"> Descrição Comercial <span class="text-danger font-bold">{{ $description_Com }} </span><<< <a wire:click.prevent="copyCom" href="">Click para copiar</a></label>
